...
vim.keymap.set({ "n", "v" }, "<leader>rp", [["_dP]], { desc = "Paste over selected text" })
vim.keymap.set({ "n", "v" }, "<leader>ry", [["+y]], { desc = "Yank into the clipboard" })
vim.keymap.set("n", "<leader>rY", [["+Y]], { desc = "Yank whole line into the clipboard" })
vim.keymap.set({ "n", "v" }, "<leader>rd", [["_d]], { desc = "Delete without yanking" })
